    ...
    <div data-options="region:'west'" style="width:220px;padding-top: 0px;background-color: gray">
	    	<ul id="accordion" class="accordion" style="width: 198px">
				<li>
					...
					<ul class="submenu">
						<li><a href="#" url="${pageContext.request.contextPath}/viewCategory.do" onclick="openTab(this)">查看类别</a></li>
						<li><a href="#" url="${pageContext.request.contextPath}/views/editCategory.jsp" onclick="openTab(this)">编辑类别</a></li>
					</ul>
				</li>
				<li>
					<div class="link"><i class="fa fa-automobile"></i>视频管理<i class="fa fa-chevron-down"></i></div>
					<ul class="submenu">
						<li><a href="#" url="${pageContext.request.contextPath}/listVideos.do" onclick="openTab(this)">查看视频</a></li>
						<li><a href="#" url="" onclick="openTab(this)">视频内容</a></li>
						<li><a href="#" url="${pageContext.request.contextPath}/videoAddPage.do" onclick="openTab(this)">添加视频</a></li>
					</ul>
				</li>
			</ul>
